...
// <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&family=Playfair+Display:wght@500;600;700&family=Fira+Code:wght@400;500&display=swap" rel="stylesheet" />
...
export default function App() {
  ...
  const links = {
    ...
    linkedin: "https://www.linkedin.com/in/tashmith-bopage",
        ...
        <div className="space-y-16 border-l-2 border-[#0D9488]/30 pl-8 relative ml-4 md:ml-0">
          ...
          <div className="relative group">
            ...
            <p className="text-slate-300 mt-4 leading-relaxed" style={{ fontWeight: 400 }}>
              I am an IIT Computer Science undergraduate at the University of Westminster with skills in Python, Java, JavaScript, React, TypeScript, Node.js, MongoDB, and Firebase. I'm interested in full-stack and software development.
            </p>
      ...
      <section id="projects" className="py-24 bg-slate-800 border-y border-slate-700">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-8">
            ...
            <div className="bg-slate-900 border border-slate-700 rounded-2xl overflow-hidden hover:border-[#0D9488]/50 hover:shadow-lg hover:shadow-[#0D9488]/10 transition-all flex flex-col group">
              ...
              <div className="p-8 flex flex-col flex-grow">
                ...
                <p className="text-[#0D9488] text-sm font-semibold leading-relaxed mb-6 flex-grow" style={{ fontFamily: "'Fira Code', monospace" }}>
                  React, JavaScript, TypeScript, Google Maps, NoSQL
                </p>
            ...
            {/* Project 2: Estate Agent — clean, no overlay text */}
            <div className="bg-slate-900 border border-slate-700 rounded-2xl overflow-hidden hover:border-[#0D9488]/50 hover:shadow-lg hover:shadow-[#0D9488]/10 transition-all flex flex-col group">
              <div className="h-48 bg-slate-800 w-full overflow-hidden border-b border-slate-700">
                <img
                  src={estateAgentImg}
            ...
            {/* Project 3: Portfolio — object-top to show top of image */}
            <div className="bg-slate-900 border border-slate-700 rounded-2xl overflow-hidden hover:border-[#0D9488]/50 hover:shadow-lg hover:shadow-[#0D9488]/10 transition-all flex flex-col group">
              <div className="h-48 bg-slate-800 w-full overflow-hidden border-b border-slate-700">
                <img
                  src={portfolioImg}
        ...
        <div className="bg-slate-800 border border-slate-700 rounded-3xl p-8 shadow-xl">
          <form className="space-y-6">
            <div>
              ...
              <input type="text" className="w-full mt-2 bg-slate-900 border border-slate-700 rounded-xl p-4 text-slate-100 focus:outline-none focus:border-[#0D9488]/50 focus:bg-slate-800 transition-colors" placeholder="Mesith Bopage" />
            </div>
            <div>
              <label className="text-sm text-slate-400 font-medium ml-1" style={{ letterSpacing: '0.03em' }}>Your Email</label>
              <input type="email" className="w-full mt-2 bg-slate-900 border border-slate-700 rounded-xl p-4 text-slate-100 focus:outline-none focus:border-[#0D9488]/50 focus:bg-slate-800 transition-colors" placeholder="tashmith.20231087@iit.ac.lk" />
            </div>
            <div>
              <label className="text-sm text-slate-400 font-medium ml-1" style={{ letterSpacing: '0.03em' }}>Message</label>
              <textarea rows="4" className="w-full mt-2 bg-slate-900 border border-slate-700 rounded-xl p-4 text-slate-100 focus:outline-none focus:border-[#0D9488]/50 focus:bg-slate-800 transition-colors resize-none" placeholder="How can I help you?"></textarea>
            </div>
            <button type="button" className="w-full bg-[#0D9488] text-white font-bold py-4 rounded-xl hover:bg-[#0f766e] transition-transform hover:-translate-y-1 shadow-md hover:shadow-lg" style={{ letterSpacing: '0.05em' }}>
              Send Message
            </button>
          </form>
        </div>
